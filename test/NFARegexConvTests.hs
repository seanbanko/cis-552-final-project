...
-- prop_testToNFA :: Ord a => NFA a -> Bool
...
-- prop_acceptRegExp :: RegExp -> Property
-- prop_acceptRegExp = forAll genRegExpString r
--   case genRegExpString r of
--     Just s -> forAll s $ accept r s == acceptN (toNFA r) s
--     Nothing -> property $ RegExp.isVoid r 
